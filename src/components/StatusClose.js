...
class StatusClose extends Component {
  constructor(props) {
    super(props);
    this.state = {
      hovering: false
  ...
  render() {
    ...
    return (
      ...
      >
        <Open hovering={hovering}> Tekrar Aç </Open>
        <Close hovering={hovering}> Kapatıldı </Close>
      </Container>
    );
  }
}
